...
.. _darth_vader_rpi: api_reference.html
...
sounds such as some of his famous quotes. See the `README <README.html>`_ for
...
.. important::
   ...
   your own computer because the package `darth_vader_rpi`_ uses the library
