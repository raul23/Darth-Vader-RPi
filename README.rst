...
`:star:`
   ...
   test the program on your own computer because the package
...
* The *Quotes button* plays famous Darth Vader quotes when pressed. For
  ...
  * `"I am your father"`_
  * `"Nooooo"`_: it is also used for the `closing sound`_ when the script ``start_dv`` exits
...
If you get the warning message from *pip* that the script ``start_dv`` is
...
Script ``start_dv``
-------------------
Once the package ``darth_vader_rpi`` is installed, you should have access to
...
`:star:`
   ...
   In order to stop the script ``start_dv`` at any moment, press
   ``ctrl`` + ``c``.
...
``start_dv``, you can run the script with the flag **-s**. It will make use
...
.. _add more quotes: https://darth-vader-rpi.readthedocs.io/en/latest/change_default_settings.html#add-darth-vader-quotes-label
.. _closing sound: https://darth-vader-rpi.readthedocs.io/en/latest/change_default_settings.html#change-closing-sound-label
.. _Change default settings: https://darth-vader-rpi.readthedocs.io/en/latest/change_default_settings.html
.. _Change keymap: https://darth-vader-rpi.readthedocs.io/en/latest/change_default_settings.html#change-keymap-label
